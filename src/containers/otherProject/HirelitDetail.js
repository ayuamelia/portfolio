...
const hirelitDetails = [
  {
    title: "Currency Sync to Redis",
    dag: "dev_integrasi_sync_redis_currency",
    key: [
      "Integrated Approval Workflow: The system manages the entire lifecycle of a new hire, including integrated processes for new employee requests from division heads and final approvals from directors.",
      "Multi-Actor Access Control: The application defines clear roles and permissions for different users, including Division Heads, HRD, Applicants, and Directors, ensuring users only access relevant features",
      "Centralized Job Vacancy Management: Provides HRD with tools to create and manage structured and accurate job vacancy information, stored centrally in a database.",
      "Online Applicant Portal: Allows candidates to apply for jobs online, upload required documents, and track their application status through a dedicated portal.",
      "Automated Email Notifications: The system automatically sends email notifications to applicants for status changes and interview invitations, improving communication and efficiency.",
      "Secure Document Handling: Applicant documents are uploaded and stored digitally, preventing loss or damage and making them easily searchable.",
      "Admin Dashboard & Reporting: An administrative dashboard provides an overview of recruitment activities, and the system can generate reports on recruitment and employee requests."
    ],
    tech: [
...
export default function HirelitDetail() {
